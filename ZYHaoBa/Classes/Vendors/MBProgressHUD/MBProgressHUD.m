...
//	CGSize labelSize = [label.text sizeWithFont:label.font];
    NSDictionary * attrs = [NSDictionary dictionaryWithObjectsAndKeys:
                            ...
                            NSFontAttributeName,
                            nil];
    CGRect rect = [label.text boundingRectWithSize:CGSizeMake(SCREEN_WIDTH, 1000) options:(NSStringDrawingUsesLineFragmentOrigin | NSStringDrawingUsesFontLeading) attributes:attrs context:nil];
...
//								constrainedToSize:maxSize lineBreakMode:detailsLabel.lineBreakMode];
    attrs = [NSDictionary dictionaryWithObjectsAndKeys:
                            ...
                            NSFontAttributeName,
                            nil];
    rect = [detailsLabel.text boundingRectWithSize:maxSize options:(NSStringDrawingUsesLineFragmentOrigin | NSStringDrawingUsesFontLeading) attributes:attrs context:nil];
