...
//    NSString *name = [HMAccountTool account].name;
    ...
    UIBarButtonItem *item2 = [[UIBarButtonItem alloc] initWithTitle:@"发送" style:UIBarButtonItemStyleBordered target:self action:@selector(send)];
...
{
    self.navigationItem.rightBarButtonItems.lastObject.enabled = textView.hasText;
}
