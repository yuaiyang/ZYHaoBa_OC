...
@interface ShouYeTestViewController ()<NewPagedFlowViewDelegate, NewPagedFlowViewDataSource>
...
@implementation ShouYeTestViewController
...
- (void)didScrollToPage:(NSInteger)pageNumber inFlowView:(NewPagedFlowView *)flowView {
    ...
    xh(@"ShouYeTestViewController 滚动到了第%ld页",pageNumber);
}
