...
- (void)setImage:(UIImage *)image forState:(UIControlState)state{
    ...
    if (image) {
        self.line1Layer.hidden = YES;
        self.line2Layer.hidden = YES;
        self.line3Layer.hidden = YES;
        self.circleLayer.hidden = YES;
    } else {
        self.line1Layer.hidden = NO;
        self.line2Layer.hidden = NO;
        self.line3Layer.hidden = NO;
